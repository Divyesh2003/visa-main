            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <div class="page-title-heading">
                        <h2 class="title">Visit & Offical Visa </h2>
                        <p>What's your visit visa</p>
                    </div>
                    <div class="breadcrumb-wrapper">
                        <span>
                            <a title="Homepage" href="/">Home</a>
                        </span>
                        <span>Visit visa & Offical Visa</span>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-4 ttm-col-bgcolor-yes cmt-bg cmt-left-span cmt-bgcolor-grey mt_80 pt-60 mb_80 pb-60 res-991-mt-0 res-991-pt-0 widget-area sidebar-left">
                    ...
                    <aside class="widget widget-nav-menu">
                        <ul class="widget-menu">
                            ...
                            <li class="active"><a href="{{ route('visitor.visa') }}">Visit Visa</a></li>
