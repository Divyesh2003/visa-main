            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <div class="page-title-heading">
                        <h2 class="title">Work & Offical Visa </h2>
                        <p>What's your work visa</p>
                    </div>
                    <div class="breadcrumb-wrapper">
                        <span>
                            <a title="Homepage" href="/">Home</a>
                        </span>
                        <span>Work & Offical Visa</span>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-4 ttm-col-bgcolor-yes cmt-bg cmt-left-span cmt-bgcolor-grey mt_80 pt-60 mb_80 pb-60 res-991-mt-0 res-991-pt-0 widget-area sidebar-left">
                    ...
                    <aside class="widget widget-nav-menu">
                        <ul class="widget-menu">
                            ...
                            <li  class="active"><a href="{{ route('work.visa') }}">Work Visa</a></li>
                ...
                <div class="col-lg-8 content-area">
                    <div class="cmt-service-single-content-area">
                        <div class="cmt-featured-wrapper mb-40 res-991-mb-20">
                            <img class="img-fluid" src="{{ asset('assets/images/services-details_02.jpg') }}" alt="">
                        </div>
